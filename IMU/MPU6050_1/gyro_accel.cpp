...
// Variables 
int temp=0, accel_x=0, accel_y=90, accel_z=0, gyro_x=0, gyro_y=90, gyro_z=0; // Raw values varaibles
int accel_x_OC=0, accel_y_OC=90, accel_z_OC=0, gyro_x_OC=0 ,gyro_y_OC=90, gyro_z_OC=0; // offset variables
